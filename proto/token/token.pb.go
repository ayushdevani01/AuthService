...
type GenerateTokenPairRequest struct {
	...
	// audience is the JWT aud claim (publishable/public app id).
	// When empty, token-service falls back to app_id for rollout safety.
...
func (x *GenerateTokenPairRequest) GetAudience() string {
	if x != nil {
		return x.Audience
	}
	return ""
...
func (x *RefreshTokensRequest) GetAudience() string {
	if x != nil {
		return x.Audience
	}
	return ""
...
const file_token_token_proto_rawDesc = "" +
	"\n" +
	"\x11token/token.proto\x12\x05token\"\xb4\x02\n" +
	...
	"\x11refresh_token_ttl\x18\b \x01(\x03R\x0frefreshTokenTtl\x12\x1a\n" +
	"\baudience\x18\t \x01(\tR\baudience\"\xd3\x01\n" +
	...
	"\x18refresh_token_expires_at\x18\x04 \x01(\x03R\x15refreshTokenExpiresAt\"\xa0\x01\n" +
	"\x14RefreshTokensRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\x12\x15\n" +
	"\x06app_id\x18\x02 \x01(\tR\x05appId\x120\n" +
	"\x14rotate_refresh_token\x18\x03 \x01(\bR\x12rotateRefreshToken\x12\x1a\n" +
	"\baudience\x18\x04 \x01(\tR\baudience\"\xe6\x02\n" +
